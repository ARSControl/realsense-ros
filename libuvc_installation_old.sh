...
wget -O librealsense_v2_31_0.zip https://github.com/IntelRealSense/librealsense/archive/refs/tags/v2.31.0.zip
unzip ./librealsense_v2_31_0.zip -d ./libr
cd ./libr
...
cmake ../ -DFORCE_LIBUVC=true -DCMAKE_BUILD_TYPE=release -DBUILD_WITH_CUDA=true -DCMAKE_CUDA_ARCHITECTURES=native
make -j2
sudo make install
